...
import { BanknoteIcon, Building2, CreditCard } from 'lucide-react'
    ...
    <Card>
      <CardBody>
        <form onSubmit={handleSubmit(onNext)} className='space-y-6'>
          ...
          <RadioGroup {...register('method')} orientation='vertical' defaultValue='card'>
            <Radio value='card'>
            ...
            <Radio value='deposit'>Depósito bancario</Radio>
          ...
          {paymentMethod === 'transfer' && (
            <div className='bg-primary/5 rounded-lg p-4'>
              ...
              <p className='mt-4 text-sm text-gray-600'>Una vez realizada la transferencia, envía el comprobante a pagos@mitienda.com</p>
            </div>
          )}
          ...
          {paymentMethod === 'deposit' && (
            <div className='bg-primary/5 rounded-lg p-4'>
              ...
              <p className='mt-4 text-sm text-gray-600'>Una vez realizado el depósito, envía el comprobante a pagos@mitienda.com</p>
            </div>
          )}
          ...
          {paymentMethod === 'cash' && (
            <div className='bg-primary/5 rounded-lg p-4'>
              <p className='text-sm text-gray-600'>
                El pago en efectivo solo está disponible cuando recoges tu pedido en tienda. Podrás realizar el pago al momento de recoger
                tus productos.
              </p>
            </div>
          )}
